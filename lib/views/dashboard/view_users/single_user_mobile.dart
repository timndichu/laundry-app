...
class SingleUserMobile extends StatefulWidget {
  @override
  _SingleUserMobileState createState() => _SingleUserMobileState();
}

class _SingleUserMobileState extends State<SingleUserMobile> {
  @override
